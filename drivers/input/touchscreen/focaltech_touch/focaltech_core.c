...
#endif
/* jianghan@20210610 add for Distinguish vendor Begin*/
extern char *saved_command_line;
/* jianghan@20210610 add for Distinguish vendor End*/
/*****************************************************************************
...
/* jianghan@20210610 add for Distinguish vendor Begin*/
	char *lcd_name;
	char name[64] = "auo_ft2338";
	lcd_name = strstr(saved_command_line,name);
/* jianghan@20210610 add for Distinguish vendor End*/
    FTS_FUNC_ENTER();
/* jianghan@20210610 add for Distinguish vendor Begin*/
	if(IS_ERR_OR_NULL(lcd_name)){
		FTS_ERROR("[touch]get cmdline fail or lcd not match tp");
		return -ENODEV;
	}
/* jianghan@20210610 add for Distinguish vendor End*/
