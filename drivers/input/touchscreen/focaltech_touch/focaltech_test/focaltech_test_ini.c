...
static int get_test_threshold_incell(void)
{
	...
	fts_init_buffer(thr->panel_differ_min, thr->basic.panel_differ, node_num, 0, 0, 0);
	fts_init_buffer(thr->panel_differ_max, 100000, node_num, 0, 0, 0);
    /* detail threshold */
	...
	get_detail_threshold("PanelDiffer_Min_Tx", true, thr->panel_differ_min, node_num);
